...
import { TotalChecksWidget } from '@/modules/background-checks/components/widgets/TotalChecksWidget';
import { ActiveChecksWidget } from '@/modules/background-checks/components/widgets/ActiveChecksWidget';
import { CompletionRateWidget } from '@/modules/background-checks/components/widgets/CompletionRateWidget';
import { AvgCompletionTimeWidget } from '@/modules/background-checks/components/widgets/AvgCompletionTimeWidget';
import { PendingActionsWidget } from '@/modules/background-checks/components/widgets/PendingActionsWidget';
import { CheckTypeDistributionWidget } from '@/modules/background-checks/components/widgets/CheckTypeDistributionWidget';
import { StatusDistributionWidget } from '@/modules/background-checks/components/widgets/StatusDistributionWidget';
import { RecentActivityWidget } from '@/modules/background-checks/components/widgets/RecentActivityWidget';
