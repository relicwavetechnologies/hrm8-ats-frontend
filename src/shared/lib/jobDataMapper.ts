...
export function mapBackendJobToFrontend(backendJob: any): Job {
  return {
    ...
    globalPublishConfig: backendJob.globalPublishConfig || {
      ...
      budgetTier: backendJob.jobTargetBudgetTier || 'none',
      customBudget: backendJob.jobTargetBudget,
      hrm8ServiceRequiresApproval: false,
      hrm8ServiceApproved: !!backendJob.jobTargetApproved,
      easyApplyConfig: {
        enabled: false,
        type: 'full',
        hostedApply: false,
    ...
    jobTargetSync: backendJob.jobTargetSync,
    ...
    jobTargetBudgetTier: backendJob.jobTargetBudgetTier,
    jobTargetChannels: backendJob.jobTargetChannels,
    jobTargetApproved: backendJob.jobTargetApproved,
    jobTargetStatus: backendJob.jobTargetStatus,
    jobTargetBudgetSpent: backendJob.jobTargetBudgetSpent,
...
export function mapBackendJobToFormData(backendJob: any): Partial<JobFormData> {
  ...
  return {
    ...
    distributionScope: normalizedJob.distributionScope || 'HRM8_ONLY',
    globalPublishConfig: normalizedJob.globalPublishConfig || {
      channels: normalizedJob.jobTargetChannels || [],
      budgetTier: normalizedJob.jobTargetBudgetTier || 'none',
      customBudget: normalizedJob.jobTargetBudget,
      hrm8ServiceRequiresApproval: false,
      hrm8ServiceApproved: !!normalizedJob.jobTargetApproved,
      easyApplyConfig: {
        enabled: false,
        type: 'full',
        hostedApply: false,
